...
export const translations = {
  de: {
    ...
    auth: {
      ...
      organizationRequired: "Wählen Sie eine Organisation, bevor Sie synchronisieren.",
  ...
  en: {
    ...
    auth: {
      ...
      organizationRequired: "Select an organization before synchronizing.",
  ...
  am: {
    ...
    auth: {
      ...
      organizationRequired: "ከማመሳሰልዎ በፊት ድርጅት ይምረጡ።",
  ...
  ti: {
    ...
    auth: {
      ...
      organizationRequired: "ቅድሚ ምትእስሳር ትካል ምረጹ።",
